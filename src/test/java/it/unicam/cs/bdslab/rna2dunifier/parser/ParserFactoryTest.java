...
class ParserFactoryTest {
    ...
    void detectRnaview() throws IOException {
        String content = "PDB data file name: test.pdb\n" +
                "BEGIN_base-pair\n" +
    ...
    void detectUnknownThrows() {
        ...
        assertThrows(IllegalArgumentException.class,
                () -> ParserFactory.detectTool(toBuffered(garbage)));
    }
    ...
    void detectToolResetsStream() throws IOException {
        ...
        assertTrue(reconstituted.contains("BEGIN_base-pair"),
                "The stream should be resetted after detectTool");
    }
}